  ...
  return (
    <div className="container py-16 min-h-[70vh] flex items-center justify-center">
      <div className="w-full max-w-md bg-white rounded-lg shadow-premium p-8 border border-navy/5">
        ...
        <button onClick={otpSend} disabled={loading} className="mt-3 w-full border-2 border-gold text-gold rounded-md py-3 font-bold hover:bg-gold hover:text-white transition-all">
